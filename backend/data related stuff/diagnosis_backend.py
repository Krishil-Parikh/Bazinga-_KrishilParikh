...
class MedicalAnalysisAgent:
    def __init__(self):
        ...
        # Initialize models
        self.brain_model = "/Users/krishilparikh/Downloads/brain_tumor.pth"
        self.chest_model = "/Users/krishilparikh/Downloads/pneumonia_detection_cnn_lstm_model.h5"
        ...
        try:
            ...
            brain_model_path = os.path.join(os.getcwd(), 'models', '/Users/krishilparikh/Downloads/brain_tumor.pth')
        ...
        try:
            chest_model_path = os.path.join(os.getcwd(), 'models', '/Users/krishilparikh/Downloads/pneumonia_detection_cnn_lstm_model.h5')
