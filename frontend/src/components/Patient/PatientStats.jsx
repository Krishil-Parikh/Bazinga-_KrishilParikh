...
import { Users, Clock, Building, CheckCircle, AlertTriangle } from "lucide-react"
    ...
    <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-5">
      ...
      <Card>
        ...
        <CardContent>
          ...
          <p className="text-xs text-muted-foreground">4 urgent cases</p>
        </CardContent>
      </Card>
      ...
      <Card>
        ...
        <CardContent>
          ...
          <p className="text-xs text-muted-foreground">Today's discharges</p>
        </CardContent>
      </Card>
      ...
      <Card>
        ...
        <CardContent>
          ...
          <p className="text-xs text-red-500">2 require immediate attention</p>
        </CardContent>
      </Card>
    </div>
  )
